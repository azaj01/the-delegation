       ...
       <div className="flex items-center gap-3 self-start mt-2 min-w-0">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="text-[10px] font-medium text-zinc-400 hover:text-zinc-900 transition-colors truncate"
            >
              @arturitu
            </a>
            <a
              ...
              target="_blank"
              rel="noopener"
              className="text-zinc-300 hover:text-zinc-900 transition-colors shrink-0"
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="relative text-zinc-400 hover:text-zinc-900 transition-colors p-1"
            title="API Key (BYOK)"
          >

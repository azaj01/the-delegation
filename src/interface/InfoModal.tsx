    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center p-6 pointer-events-auto overflow-hidden">
      ...
      >
        <div className="max-w-md mx-auto">
          <h2 className="text-3xl font-black text-darkDelegation leading-[1.1] mb-6 tracking-tight text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-8">
            <button
              onClick={onClose}
              className="px-8 py-3 bg-darkDelegation text-white rounded-full text-[11px] font-black uppercase tracking-[0.2em] hover:bg-black transition-all active:scale-95 cursor-pointer"
            >
              Close
            </button>

            <p className="text-[9px] font-bold text-zinc-300 uppercase tracking-[0.15em] text-center leading-loose">
              An experiment by <a href="https://unboring.net" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-darkDelegation transition-colors">Arturo Paracuellos</a>
            </p>
          </div>
        </div>
      </div>
